...
static void test_tokenize_empty(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 1, "Empty string should produce 0 tokens");
...
static void test_tokenize_spaces(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 1, "Whitespace should produce 0 tokens");
...
static void test_tokenize_identifiers(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 5, "Expected 4 identifier tokens");
...
static void test_tokenize_numbers(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 5, "Expected 4 number tokens");
...
static void test_tokenize_invalid_numbers(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 3, "Expected 2 invalid number tokens");
...
static void test_tokenize_operators(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 14, "Expected 13 operator tokens");
...
static void test_tokenize_keywords(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 8, "Expected 7 keyword tokens");
...
static void test_tokenize_mixed(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 14, "Expected 13 tokens");
...
static void test_tokenize_example(void) {
  ...
  ASSERT_EQ(lexer->nr_token, 10, "Expected 9 tokens from example");
  ...
  for (int i = 0; i < lexer->nr_token - 1; i++) {
    ASSERT_EQ(lexer->tokens[i].type, expected_types[i],
